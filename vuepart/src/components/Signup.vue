    ...
    <div class="border p-10 border-grey-light shadow rounded">
      ...
      <form @submit.prevent="signup">
        ...
        <div class="mb-6">
          ...
          <input type="email" v-model="email" class="input" id="email" placeholder="Enter your E-mail">
        </div>

        <div class="mb-6">
          <label for="password" class="label">Password</label>
          <input type="password" v-model="password" class="input" id="password" placeholder="Enter Password">
        </div>
