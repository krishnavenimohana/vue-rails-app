<template>
  <div class="max-w-md m-auto py-10">
    ...
    <form action="" @submit.prevent="addArtist">
      ...
      <input type="submit" value="Add Artist" class="font-sans font-bold px-4 rounded cursor-pointer no-underline green hover:bg-green-dark block w-full py-4 text-white items-center justify-center" />
    </form>
